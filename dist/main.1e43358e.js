    ...
    value: function generate() {
      for (var y = 0; y < this.height; y++) {
        ...
        for (var x = 0; x < this.width; x++) {
          this.matrix[y].push(new _Tile.Tile(x, y));
        }
      }
    }
  }]);
...
exports.Map = Map;
},{"./Tile":"src/Tile.js"}],"src/main.js":[function(require,module,exports) {
"use strict";

var _Map = require("./Map");

console.log("------------ A* Pathfinder! ------------");
var map = new _Map.Map(5, 3);
map.generate();
console.log(map.matrix);
},{"./Map":"src/Map.js"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
